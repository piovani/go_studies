...
func (repositorio Publicacoes) DeletarPublicacao(publicacaoID int64) error {
...
func (repositorio Publicacoes) Curtir(publicacaoID int64) error {
...
func (repositorio Publicacoes) Descurtir(publicacaoID int64) error {
